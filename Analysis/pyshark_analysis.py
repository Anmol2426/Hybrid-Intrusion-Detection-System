...
PCAP_FILE = "C:\\Project\\Captured_Data\\captured_traffic.pcap"
OUTPUT_FOLDER = "C:\\Project\\Captured_Data"  # Folder to save the CSV file
...
# Example usage
raw_data = extract_features(PCAP_FILE)